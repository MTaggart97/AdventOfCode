...
with open('input.txt', 'r', encoding='utf8') as f:
    for line in f:
        ...
        total_octopi += len(energy_levels[-1])
...
while not stop:
    ...
    if (current_iter_flashes == total_octopi):        
        stop = True

print(f'All octopi flashed on iteration {iteration}')
